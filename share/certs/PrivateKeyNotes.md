...
unlocked to sign the Unbreakablecoin-Qt.app bundle.
...
allowing somebody to distribute a Unbreakablecoin-Qt.app or bitcoin-qt-setup.exe with a valid
...
that the unbreakablecoin-qt.exe file inside the installer had not been tampered with.
